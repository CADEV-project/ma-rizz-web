...
const DEFAULT_SOCKET_SERVER_URL = 'http://localhost:8000/api';
...
export const SERVER_SETTINGS = {
  ...
  SOCKET_SERVER_URL: process.env.SOCKET_SERVER_URL ?? DEFAULT_SOCKET_SERVER_URL,
...
export const CLIENT_SETTINGS = {
  ...
  SOCKET_SERVER_URL: process.env.NEXT_PUBLIC_SOCKET_SERVER_URL ?? DEFAULT_SOCKET_SERVER_URL,
} as const;
